  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-surface-50 px-6">
      <div className="card p-8 max-w-sm w-full text-center">
        <img src="/logo.png" alt="Kreati" className="h-10 w-auto mx-auto mb-6" />
        ...
        <button
          ...
          disabled={loading}
          className="mt-8 w-full py-4 px-4 bg-brand-500 hover:bg-brand-400 disabled:opacity-60 rounded-full font-semibold text-white text-base transition-all duration-200 flex items-center justify-center gap-3 active:scale-[0.98] shadow-md shadow-brand-500/30"
        >
          {loading ? (
